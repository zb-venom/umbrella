<template>
  <div class="container">
    <form class="form" onsubmit="event.preventDefault();">
      ...
      <div class="form-body">
        <p class="info-block">
          Please enter your email address and password to access the
          application.
        </p>
        <router-link class="signup-block" to="/signup">
          Don't have an account? Signup in the app now.
        </router-link>
        ...
        <div class="button-box">
          <button class="button-lose" v-on:click="login">
...
export default {
  ...
  methods: {
    login: function() {
      ...
      axios
        .post("https://authdiplom.herokuapp.com/api/auth/login", {
